...
from main_db import admin_register_db


class AdminRegisterPanel(object):
    def setupUi(self, MainWindow):
        ...
        self.adminlabel.setGeometry(QtCore.QRect(355, 50, 91, 41))
    ...
    def registerbutton(self, values_1):
        ...
        if len(username) == 0 or len(password) == 0:
            ...
            self.ui.setupUi (self.MainWindow)
            self.MainWindow.show()
            values_1 = (username, first_name, last_name, programing_language, password)
            admin_register_db(values_1)
